# Malu Investment CC (demo)

Earlier demo website for Malu Investment CC.

**Status:** Superseded demo  
**Visibility:** Public

## What this is

Original demo build. Superseded by `malu-investment-2`, which serves the live domain. Retained for history.
...
```bash
git clone https://github.com/tangison/malu-investment-cc.git
cd malu-investment-cc
npm install
npm run dev
```
...
> **Repository note.** Superseded by `malu-investment-2`. Archive once confirmed.
