        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-malu-gold hover:text-malu-gold/80 transition-colors text-sm mb-2"
            >
        ...
        <div className="mt-12 pt-8 border-t border-malu-grey/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-malu-white/30 text-xs">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-malu-gold/50 hover:text-malu-gold transition-colors"
            >
              Tangison Studio
            </a>
          </p>
